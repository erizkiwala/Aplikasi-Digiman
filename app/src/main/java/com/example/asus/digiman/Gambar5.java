    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Gambar5.this, MainActivity.class);
        ...
        tentang.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Gambar5.this , Tentang.class);
                startActivity(intent);
            }
        });
        ...
        email.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Gambar5.this, email.class);
                startActivity(intent);
            }
        });
        ...
        telepon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Gambar5.this, Telepon.class);
                startActivity(intent);
            }
        });
    }
